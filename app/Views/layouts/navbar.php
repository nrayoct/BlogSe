        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6 ml-auto d-flex justify-content-end">
                    <form action="" class="search-form d-inline-block" method="get">
                        <div class="d-flex">
                            <input type="text" class="form-control" placeholder="Search..." name="keyword" autofocus autocomplete="off">
                            <button type="submit" name="submit" class="btn btn-secondary"><span class="icon-search"></span></button>
                        </div>
                    </form>
                </div>
        ...
        <div class="site-navbar py-2 js-sticky-header site-navbar-target d-none pl-0 d-lg-block" role="banner">
            ...
            <div class="container">
                <div class="d-flex align-items-center">
                    ...
                    <a class="btn align-right" href="/logout">Logout</a>
